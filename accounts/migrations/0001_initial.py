    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(choices=[('admin', 'Administrador'), ('gerente', 'Gerente'), ('supervisor', 'Supervisor'), ('cajero', 'Cajero'), ('cocinero', 'Cocinero'), ('mesero', 'Mesero'), ('inventario', 'Encargado de Inventario'), ('rrhh', 'Recursos Humanos')], max_length=50, unique=True)),
